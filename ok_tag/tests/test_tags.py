...
class ApproveTagSuggestionTestCase(TestCase):
    def setUp(self):
        super(ApproveTagSuggestionTestCase, self).setUp()
    ...
    def test_approve(self):
        ...
        ok_tag.tag_suggestions.approve(None, None, [tag_suggestion])
...
class TagSuggestionFormTestCase(TestCase):
    def setUp(self):
        super(TagSuggestionFormTestCase, self).setUp()
        self.user = User.objects.create_user('user_1', 'user_1@example.com', '123456')
...
class SuggestionsTestCase(TestCase):
    def setUp(self):
        ...
        ok_tag.tag_suggestions._all_tags_names = ['tag1']

    def test_get_tags_in_text(self):
        text = "tag1 ate the cat"
        tags_count = ok_tag.tag_suggestions.get_tags_in_text(text)
