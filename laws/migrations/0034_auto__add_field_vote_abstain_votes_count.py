...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vote.abstain_votes_count'
        db.add_column(u'laws_vote', 'abstain_votes_count',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vote.abstain_votes_count'
        db.delete_column(u'laws_vote', 'abstain_votes_count')
