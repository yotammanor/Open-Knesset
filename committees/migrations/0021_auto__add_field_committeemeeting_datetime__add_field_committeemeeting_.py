...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CommitteeMeeting.datetime'
        db.add_column(u'committees_committeemeeting', 'datetime',
                      self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CommitteeMeeting.knesset_id'
        db.add_column(u'committees_committeemeeting', 'knesset_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CommitteeMeeting.datetime'
        db.delete_column(u'committees_committeemeeting', 'datetime')

        # Deleting field 'CommitteeMeeting.knesset_id'
        db.delete_column(u'committees_committeemeeting', 'knesset_id')
