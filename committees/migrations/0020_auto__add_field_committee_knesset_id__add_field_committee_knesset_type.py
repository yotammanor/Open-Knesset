...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Committee.knesset_id'
        db.add_column(u'committees_committee', 'knesset_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Committee.knesset_type_id'
        db.add_column(u'committees_committee', 'knesset_type_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Committee.knesset_parent_id'
        db.add_column(u'committees_committee', 'knesset_parent_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Committee.last_scrape_time'
        db.add_column(u'committees_committee', 'last_scrape_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Committee.name_eng'
        db.add_column(u'committees_committee', 'name_eng',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Committee.name_arb'
        db.add_column(u'committees_committee', 'name_arb',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Committee.start_date'
        db.add_column(u'committees_committee', 'start_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Committee.end_date'
        db.add_column(u'committees_committee', 'end_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Committee.knesset_description'
        db.add_column(u'committees_committee', 'knesset_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Committee.knesset_description_eng'
        db.add_column(u'committees_committee', 'knesset_description_eng',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Committee.knesset_description_arb'
        db.add_column(u'committees_committee', 'knesset_description_arb',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Committee.knesset_note'
        db.add_column(u'committees_committee', 'knesset_note',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Committee.knesset_note_eng'
        db.add_column(u'committees_committee', 'knesset_note_eng',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Committee.knesset_portal_link'
        db.add_column(u'committees_committee', 'knesset_portal_link',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
        ...
        if not db.dry_run:
            ...
            for committee in orm.Committee.objects.all():
                if committee.pk in trans:
                    committee.knesset_id = trans[committee.pk]
                    committee.save()

    def backwards(self, orm):
        # Deleting field 'Committee.knesset_id'
        db.delete_column(u'committees_committee', 'knesset_id')

        # Deleting field 'Committee.knesset_type_id'
        db.delete_column(u'committees_committee', 'knesset_type_id')

        # Deleting field 'Committee.knesset_parent_id'
        db.delete_column(u'committees_committee', 'knesset_parent_id')

        # Deleting field 'Committee.last_scrape_time'
        db.delete_column(u'committees_committee', 'last_scrape_time')

        # Deleting field 'Committee.name_eng'
        db.delete_column(u'committees_committee', 'name_eng')

        # Deleting field 'Committee.name_arb'
        db.delete_column(u'committees_committee', 'name_arb')

        # Deleting field 'Committee.start_date'
        db.delete_column(u'committees_committee', 'start_date')

        # Deleting field 'Committee.end_date'
        db.delete_column(u'committees_committee', 'end_date')

        # Deleting field 'Committee.knesset_description'
        db.delete_column(u'committees_committee', 'knesset_description')

        # Deleting field 'Committee.knesset_description_eng'
        db.delete_column(u'committees_committee', 'knesset_description_eng')

        # Deleting field 'Committee.knesset_description_arb'
        db.delete_column(u'committees_committee', 'knesset_description_arb')

        # Deleting field 'Committee.knesset_note'
        db.delete_column(u'committees_committee', 'knesset_note')

        # Deleting field 'Committee.knesset_note_eng'
        db.delete_column(u'committees_committee', 'knesset_note_eng')

        # Deleting field 'Committee.knesset_portal_link'
        db.delete_column(u'committees_committee', 'knesset_portal_link')
