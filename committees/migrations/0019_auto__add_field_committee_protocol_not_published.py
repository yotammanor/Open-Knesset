...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Committee.protocol_not_published'
        db.add_column(u'committees_committee', 'protocol_not_published',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Committee.protocol_not_published'
        db.delete_column(u'committees_committee', 'protocol_not_published')
