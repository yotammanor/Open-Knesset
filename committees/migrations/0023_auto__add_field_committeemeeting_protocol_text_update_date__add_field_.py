...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CommitteeMeeting.protocol_text_update_date'
        db.add_column(u'committees_committeemeeting', 'protocol_text_update_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CommitteeMeeting.protocol_parts_update_date'
        db.add_column(u'committees_committeemeeting', 'protocol_parts_update_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CommitteeMeeting.protocol_text_update_date'
        db.delete_column(u'committees_committeemeeting', 'protocol_text_update_date')

        # Deleting field 'CommitteeMeeting.protocol_parts_update_date'
        db.delete_column(u'committees_committeemeeting', 'protocol_parts_update_date')
