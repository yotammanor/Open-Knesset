...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Committee', fields ['type']
        db.create_index(u'committees_committee', ['type'])


    def backwards(self, orm):
        # Removing index on 'Committee', fields ['type']
        db.delete_index(u'committees_committee', ['type'])
