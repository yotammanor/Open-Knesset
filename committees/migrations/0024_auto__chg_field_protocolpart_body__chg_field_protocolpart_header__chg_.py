...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProtocolPart.body'
        db.alter_column(u'committees_protocolpart', 'body', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'ProtocolPart.header'
        db.alter_column(u'committees_protocolpart', 'header', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'ProtocolPart.type'
        db.alter_column(u'committees_protocolpart', 'type', self.gf('django.db.models.fields.TextField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'ProtocolPart.body'
        db.alter_column(u'committees_protocolpart', 'body', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'ProtocolPart.header'
        db.alter_column(u'committees_protocolpart', 'header', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'ProtocolPart.type'
        db.alter_column(u'committees_protocolpart', 'type', self.gf('django.db.models.fields.TextField')(default='', max_length=20))
