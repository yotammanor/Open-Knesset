...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Agenda.infogram_external_identifier'
        db.add_column(u'agendas_agenda', 'infogram_external_identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Agenda.infogram_src'
        db.add_column(u'agendas_agenda', 'infogram_src',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Agenda.infogram_external_identifier'
        db.delete_column(u'agendas_agenda', 'infogram_external_identifier')

        # Deleting field 'Agenda.infogram_src'
        db.delete_column(u'agendas_agenda', 'infogram_src')
    ...
    models = {
        u'agendas.agenda': {
            ...
            'infogram_external_identifier': ('django.db.models.fields.CharField', [], {'max_length': '300', 'null': 'True', 'blank': 'True'}),
            'infogram_src': ('django.db.models.fields.CharField', [], {'max_length': '300', 'null': 'True', 'blank': 'True'}),
