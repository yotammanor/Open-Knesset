...
agenda_list_view = AgendaListView(queryset=Agenda.objects.all(), paginate_by=0,
                                  extra_context={'title': ugettext('Agendas')})
...
agenda_more_details_views = patterns('', url(r'^more-votes/$', AgendaVotesMoreView.as_view(),
                                             name='agenda-detail-more-votes'),
                                     url(r'^more-bills/$', AgendaBillsMoreView.as_view(),
                                         name='agenda-detail-more-bills'),
                                     url(r'^more-meetings/$', AgendaMeetingsMoreView.as_view(),
                                         name='agenda-detail-more-meetings'),
                                     url(r'^member/(?P<member_id>\d+)/$', agenda_mk_detail_view,
                                         name='mk-agenda-detail'),
...
urlpatterns = patterns('',
                       ...
                       url(r'^(?P<pk>\d+)/', include(agenda_more_details_views)),
