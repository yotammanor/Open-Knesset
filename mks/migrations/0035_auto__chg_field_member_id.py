...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Member.id'
        db.alter_column(u'mks_member', 'id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))

    def backwards(self, orm):

        # Changing field 'Member.id'
        db.alter_column(u'mks_member', u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))
